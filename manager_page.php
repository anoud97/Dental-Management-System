...
<body onload="setInterval(showTime , 500); showDateInfo();">
    ...
    <div class="row flex-grow-1">
                ...
                <div class="container-fluid"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse" id="navcol-1">
                        <ul class="nav navbar-nav d-block left_nav">
                            <li class="nav-item left_nav_item menue_list_item activated" role="presentation"><a class="nav-link nav_item_link" href="manager_page.php" ><img class="menue_list_icon" src="../images/home.png">Manager Page</a></li>     
        ...
        <section class="main_content_section">
            <p class="text-center website_word_header">Wellcome to Manager Page</p>
            <div style="width: 440px;height: 2px;margin-right: auto;margin-left: auto;background-color: #6cebe3;"></div>
            <p class="text-center website_word">from this page you can :<br>  show all patients  - show patient file  <br> and another jobs</p>
