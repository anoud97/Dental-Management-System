...
<body onload="setInterval(showTime , 500);  showDateInfo();">
    ...
    <div class="row flex-grow-1">
                ...
                <div class="container-fluid"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse" id="navcol-1">
                        <ul class="nav navbar-nav d-block left_nav">
                            <li class="nav-item left_nav_item menue_list_item activated" role="presentation"><a class="nav-link nav_item_link" href="student_page.php" ><img class="menue_list_icon" src="../images/home.png">Student Page</a></li>    
                            ...
                            <li class="nav-item left_nav_item menue_list_item" role="presentation"><a class="nav-link nav_item_link" href="available_times.php" ><img class="menue_list_icon" src="../images/available_time.png">available times</a></li>                     
                        </ul>
                    </div>
                </div>
            </nav>
        ...
        <section class="main_content_section">
            <p class="text-center website_word_header">Wellcome to Student Page</p>
            <div style="width: 35%;height: 2px;margin-right: auto;margin-left: auto;background-color: #6cebe3;"></div>
            <p class="text-center website_word">from this page you can :<br>  manage your available times  -  show the patients files  <br> and another jobs</p>
            <ul class="shortcut_list">
                <center>
                    ...
                    <center>
                        ...
                        <li class="shortcut_list_item" ><div><a class="" href="available_times.php"><img src="../images/available_time.png" style="width:60px; height:60px; border-radius:20px;" /><br>available times</a></div></li>
                        <div style="clear:both;"></div>
                    </center>
                    </div>
                </center>
