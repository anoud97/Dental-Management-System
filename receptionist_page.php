    ...
    <div class="row flex-grow-1">
                ...
                <div class="container-fluid"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse" id="navcol-1">
                        <ul class="nav navbar-nav d-block left_nav">
                            <li class="nav-item left_nav_item menue_list_item activated" role="presentation"><a class="nav-link nav_item_link" href="receptionist_page.php" ><img class="menue_list_icon" src="../images/home.png">Receptionist Page</a></li>    
                            ...
                            <li class="nav-item left_nav_item menue_list_item" role="presentation"><a class="nav-link nav_item_link" href="registeration_requests.php"><img class="menue_list_icon" src="../images/patients.png">registeration requests</a></li>  
        ...
        <div class="col-sm-12 col-md-9 col-lg-9 content_column">
            <section class="main_content_section">
                <p class="text-center website_word_header">Wellcome to Receptionist Page</p>
                <div style="width: 35%;height: 2px;margin-right: auto;margin-left: auto;background-color: #6cebe3;"></div>
                <p class="text-center website_word">from this page you can :<br>  open new patient file  -  show the patients files  - schedule the appoinment <br> and another jobs</p>
                <ul class="shortcut_list">
                <center>
                    <div style="text-align:center; width:43%;">
                    <center>
                        <li class="shortcut_list_item" ><div><a class="" href="patients_page.php"><img src="../images/patients.png" style="width:60px; height:60px; border-radius:20px;" /><br>patients</a></div></li>
                        <li class="shortcut_list_item" ><div><a class="" href="appoinment_schedule.php" ><img src="../images/appoinment.png" style="width:60px; height:60px; border-radius:20px;" /><br>appoinment</a></li>
                        <li class="shortcut_list_item" ><div><a class="" href="contact_page.php"><img src="../images/chat.png" style="width:60px; height:60px; border-radius:20px;" /><br>chat</a></div></li>
                        <li class="shortcut_list_item" ><div><a class="" href="patient_file.php" ><img src="../images/view_file.png" style="width:60px; height:60px; border-radius:20px;" /><br>view patient file</a></li>
                        <div style="clear:both;"></div>
                    </center>
                    </div>
                </center>
