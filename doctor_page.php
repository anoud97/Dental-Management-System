...
<body onload=" setInterval(showTime , 500);  showDateInfo();">
    ...
    <div class="row flex-grow-1">
                ...
                <div class="container-fluid"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse" id="navcol-1">
                      <ul class="nav navbar-nav d-block left_nav">
                        <li class="nav-item left_nav_item menue_list_item activated" role="presentation"><a class="nav-link nav_item_link" href="doctor_page.php"><img class="menue_list_icon" src="../images/home.png">Doctor Page</a></li> 
        ...
        <section class="main_content_section">
            <p class="text-center website_word_header">Wellcome to Doctor Page</p>
            <div style="width: 35%;height: 2px;margin-right: auto;margin-left: auto;background-color: #6cebe3;"></div>
            <p class="text-center website_word">from this page you can :<br>  chat with the reception employee - show patient file  <br> and another jobs</p>

            <ul class="shortcut_list">
                <center>
                    <div style="text-align:center; width:22%;">
                    <center>
                        <li class="shortcut_list_item" ><div><a class="" href="patient_file.php"><img src="../images/view_file.png" style="width:60px; height:60px; border-radius:20px;" /><br>view patient file</a></div></li>
                        <li class="shortcut_list_item" ><div><a class="" href="contact_page.php" ><img src="../images/chat.png" style="width:60px; height:60px; border-radius:20px;" /><br>chat</a></li>
                        <div style="clear:both;"></div>
                    </center>
                    </div>
                </center>
